...
class SugarFieldBool extends SugarFieldBase {
	...
	function getEditViewSmarty($parentFieldArray, $vardef, $displayParams) {
        ...
        return $this->ss->fetch('include/SugarFields/Fields/SugarFieldBool/SugarFieldBoolEditViewSmarty.tpl');
    }

    function getDetailViewSmarty($parentFieldArray, $vardef, $displayParams) {
        $this->setup($parentFieldArray, $vardef, $displayParams);
        return $this->ss->fetch('include/SugarFields/Fields/SugarFieldBool/SugarFieldBoolDetailViewSmarty.tpl');
    }
