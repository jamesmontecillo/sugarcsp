...
class SugarFieldRadioenum extends SugarFieldBase {
    ...
    function getEditViewSmarty($parentFieldArray, $vardef, $displayParams) {
        ...
        $vardef['stringFormat']=true;
        $vardef['separator']='<br>';
        return $this->ss->fetch('include/SugarFields/Fields/SugarFieldRadioenum/SugarFieldRadioenumEditViewSmarty.tpl');
    }

    function getDetailViewSmarty($parentFieldArray, $vardef, $displayParams) {
        $this->setup($parentFieldArray, $vardef, $displayParams);
        return $this->ss->fetch('include/SugarFields/Fields/SugarFieldRadioenum/SugarFieldRadioenumDetailViewSmarty.tpl');
    }
