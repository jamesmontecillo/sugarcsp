...
$app_strings = array (
  'ERR_SELF_REPORTING' => 'L\'utente non può dipendere da sè stesso.',
  ...
  'LBL_DST_NEEDS_FIXIN' => 'L\'applicazione necessita di una correzzione dell\'ora legale. Utilizza il link <a href=index.php?module=Administration&action=DstFix>Ripara</a> nel pannello amministrativo e correggi l\'ora legale. ',
  ...
  'ERR_INVALID_YEAR' => 'Si prega di inserire un anno di 4 cifre valido. ',
  'ERR_NEED_ACTIVE_SESSION' => 'E\' richiesta una sessione attiva per esportare il contenuto.',
  ...
  'LBL_ASSIGNED_TO_USER' => 'Assegnato a Utente:',
  ...
  'ERROR_FULLY_EXPIRED' => 'La licenza di SugarCRM della tua azienda è scaduta da più di 30 agiorni e deve essere rinnovata. Solo l\'amministratori del sistema può accedere.',
  'ERROR_LICENSE_EXPIRED' => 'La licenza di SugarCRM della tua azienda deve essere aggiornata. Solo l\'amministratori del sistema può accedere.',
  ...
  'LBL_LOGIN_TO_ACCESS' => 'Si prega si registrati per accedere a quest\'area.',
);
...
$app_list_strings = array (
  ...
  'opportunity_relationship_type_default_key' => 'Decision maker principale',
  'case_relationship_type_default_key' => 'Contatto Primario',
  'sales_stage_default_key' => 'Prospettiva',
  ...
  'product_status_default_key' => 'Spedire',
  'product_status_quote_key' => 'Offerte',
  'pricing_formula_default_key' => 'Corretto',
  'default_quote_stage_key' => 'Bozza',
  'default_order_stage_key' => 'In attesa',
  'quote_relationship_type_default_key' => 'Decision maker principale',
...
',
  ...
  array (
    ...
    'rel_user_custom' => 'Utente custom collegato',
  ...
  array (
    'team_id' => 'Gruppo attuale di Record calcolati',
