...
$app_list_strings = array (
  ...
  'lead_source_default_key' => 'Самостоятелно генерирани',
  'opportunity_relationship_type_default_key' => 'Първоначално решение',
  'case_relationship_type_default_key' => 'Първоначален контакт',
  'sales_stage_default_key' => 'Преспективна',
  'reminder_max_time' => '3600',
  'task_priority_default' => 'Междинен',
  'task_status_default' => 'Планирана',
  'meeting_status_default' => 'Планирана',
  'call_status_default' => 'Планиран',
  ...
  'pricing_formula_default_key' => 'Определен',
  'default_quote_stage_key' => 'Напиши',
  'default_order_stage_key' => 'Висяща',
  'quote_relationship_type_default_key' => 'Първоначално решение',
